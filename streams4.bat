set VIDEO_URL=http://181.57.169.89:8080/mjpg/video.mjpg
set AUDIO_FILE=audio4.mp3
set TARGET_720=rtmp://localhost/hls/stream4_720
set TARGET_480=rtmp://localhost/hls/stream4_480
set TARGET_360=rtmp://localhost/hls/stream4_360
