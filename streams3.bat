set VIDEO_URL=http://86.49.161.121/mjpg/video.mjpg
set AUDIO_FILE=audio3.mp3
set TARGET_720=rtmp://localhost/hls/stream3_720
set TARGET_480=rtmp://localhost/hls/stream3_480
set TARGET_360=rtmp://localhost/hls/stream3_360
